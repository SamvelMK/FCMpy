...
class Inference(Transfer):
    ...
    @staticmethod
    @type_check
    def __mKosko(initial_state: np.ndarray, weight_mat: np.ndarray, **params) -> np.ndarray:
    ...
    @staticmethod
    @type_check
    def __kosko(initial_state: np.ndarray, weight_mat: np.ndarray, **params) -> np.ndarray:
    ...
    @staticmethod
    @type_check   
    def __rescaled(initial_state: np.ndarray, weight_mat: np.ndarray, **params) -> np.ndarray:
