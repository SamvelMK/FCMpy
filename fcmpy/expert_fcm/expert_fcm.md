...
We will use the ExpertFcm.linguistic_terms() setter to set the linguistic terms and the associated parameters for the triangular membership function.
...
The <a href="https://link.springer.com/chapter/10.1007%2F978-3-642-25859-6_4">mamdaniMin</a> fuzzy implication rule is expressed as:
...
```
dfuz = fcm.defuzz(x=fcm.universe, mfx=aggregated, method:str='centroid')
```
